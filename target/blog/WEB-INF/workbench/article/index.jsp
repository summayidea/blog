...
<%--导入分页插件--%>
<link href="/blog/js/jquery/bs_pagination/jquery.bs_pagination.min.css" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="/blog/js/jquery/bs_pagination/en.js"></script>
<script type="text/javascript" src="/blog/js/jquery/bs_pagination/jquery.bs_pagination.min.js"></script>
</head>
...
<%--导入分页插件--%>
<link type="text/css" href="/blog/js/bs_pagination/jquery.bs_pagination.min.js"/>
<script src="/blog/bootstrap-3.3.7-dist/js/bootstrap.js"></script>
      ...
      for(var i=0;i<articles.length;i++){
        ...
        if(article.isOpen=="0"){
          $('#articleBody').append("<tr>\n" +
                  ...
                  "                <td>\n" +
                  "                    <a href=\"/blog/workbench/article/updateArticle?id="+article.aid+"\">修改</a> <a onclick=\"deleteById('"+article.aid+"') \">删除</a>&nbsp;\n" +
          ...
          $('#articleBody').append("<tr>\n" +
                  ...
                  "                <td>"+article.create_time+"</td>\n" +
                  "                <td>\n" +
                  "                    <a href=\"/blog/toView/workbench/article/updateArticle?id="+article.aid+"\">修改</a> <aonclick=\"deleteById('"+article.aid+"')\">删除</a>&nbsp;\n" +
